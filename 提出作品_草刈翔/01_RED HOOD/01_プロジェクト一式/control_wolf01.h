//=============================================================================
// 狼01操作処理 [control_wolf01.h]
// Author : 草刈 翔
//=============================================================================
#ifndef _CONTROL_WOLF01_H_
#define _CONTROL_WOLF01_H_
...
// クラスの定義
//*****************************************************************************
class CControlWolf01 : public CControl
{
public:
	CControlWolf01();						// コンストラクタ
	~CControlWolf01();						// デストラクタ
	HRESULT Init(void);						// 初期化処理
	void Uninit(void);						// 終了処理
	void Update(CScene *pScene);			// 更新処理
	static CControlWolf01 *Create(void);	// 生成処理
